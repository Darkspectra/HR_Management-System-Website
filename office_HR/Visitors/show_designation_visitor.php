...
<section id="header">
		<div class="row">
			<div class="col-md-2" style="font-size: 30px;color:#F2674A;">
				<a href="add_visitor.php" style="margin-left: 35px;color:#FFFFFF;">  Back  </a>
			</div>
			<div class="col-md-2" style="font-size: 30px;color:#F2674A;"> Vacancy!! </div>
	...
	<section id="section1">
		<div class="title"> </div>
		<table border='1' width="300px" style="margin-left: 42%; margin-right: 10%; margin-top: 50px; margin-bottom: 50px; text-align: center; background: #66b3ff;">
			<tr class='row' style="padding: 5px;">
				<th class='deli'> Designation_Name </th>
				<th class='deli'> No_Seat </th>

...
if (isset($_POST['hrid']) && isset($_POST['hrname']) && isset($_POST['hremail']) && isset($_POST['pass'])){
	...
	$sql = "INSERT INTO hr_register VALUES( '$u', '$p','$c', '$r')";
	$sql2 = "INSERT INTO hr_login VALUES( '$u', '$r')";
